...
| `Strtex` |  | python | use ER2 latex() (§3.6) | deprecated alias for strtex |
| `strtex` |  | python | use ER2 latex() (§3.6) | translates its (string) arguments to TeX format and returns the resulting string |
