...
def write_doc(rows):
    ...
    lines = [
        ...
        "",
        # One Markdown paragraph over three lines.  The pieces are joined
        # with an explicit ``+`` because a line of the generated file is
        # longer than the 79 columns PEP 8 allows in this source (§6.1).
